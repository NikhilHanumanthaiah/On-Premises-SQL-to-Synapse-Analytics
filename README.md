...
- **ADF (Azure Data Factory): **
    - [`data_ingestion_pipeline.json`](On-Premises-SQL-to-Synapse-Analytics/Docs/Scripts/ADF
/data_ingestion_pipline.json) : JSON file describing the data ingestion pipeline in Azure Data Factory.
